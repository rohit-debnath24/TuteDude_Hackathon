...
const Nabvar = () => {
    return (
        <>
            <div className='grid grid-cols-12 gap-4 pt-10  pb-5 fixed w-full        bg-[linear-gradient(1deg,rgba(218,227,230,1)_0%,rgba(143,216,227,1)_73%,rgba(83,237,237,1)_100%)]'>
