      ...
      <div className="flex min-h-screen bg-gray-50">
        <aside className="w-80 bg-white border-r rounded-lg mt-8 ml-8 flex flex-col p-6">
          <div className="flex items-center space-x-4 mb-8">
            ...
            <div>
              <div className="font-semibold text-lg">{profile.name || 'Supplier'}</div>
              <div className="text-xs text-gray-500">{profile.phone ? `+91-${profile.phone}` : ''}</div>
            </div>
          </div>
          ...
          <button className="mt-8 px-4 py-2 bg-red-100 text-red-600 rounded-lg hover:bg-red-200 font-medium transition" onClick={handleLogout}>Logout</button>
        </aside>
